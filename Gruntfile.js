module.exports = function ( grunt ) {
  ...
  grunt.registerTask( 'build', [
    'clean', 'html2js', 'jshint', 'coffeelint', 'coffee', 'copy:build_app_assets', 'copy:build_vendor_assets', 'copy:build_appjs', 'copy:build_vendor_js', 'copy:build_vendor_css', 'recess:build', 'concat:build_css', 'index:build'
  ]);
