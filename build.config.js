...
module.exports = {
  ...
  vendor_files: {
    js: [
      ...
      'vendor/pdfmake/mainjs/pdfmake.min.js',
      'vendor/angular-money-directive/angular-money-directive.js',
      'vendor/angular-chosen-localytics/chosen.js',
      'vendor/underscore/underscore.js',
      'vendor/pdfjs-dist/web/compatibility.js',
      'vendor/pdfjs-dist/web/pdf_viewer.js',
      ...
      'vendor/radialProgress/radialProgress.js'
    ],
    css: [
    ...
    assets: [
      'vendor/billsynclayouts/javascript/theme.js',
      'vendor/billsynclayouts/javascript/jquery.min.js',
