...
.factory( 'InvoicesRes', function($resource,$baseUrl){
  return $resource($baseUrl + '/api/v1/invoices/:id',
    {id: '@id'},
    {
...
.factory( 'InvoiceModerationRes', function($resource,$baseUrl){
  return $resource($baseUrl + '/api/v1/invoice_moderations/:id?hitId=:hitId',
    {id: '@id', hitId: '@hitId'},
    {
...
.factory( 'VendorsRes', function($resource,$baseUrl){
  return $resource($baseUrl + '/api/v1/vendors/:id',
    {id: '@id'},
    {
      update: {method: 'PUT', params: {id: '@id'}, isArray:false}
    });
...
.factory( 'CurrentIndividualRes', function($resource,$baseUrl){
  return $resource($baseUrl + '/api/v1/settings',
    {},
    {
...
.factory( 'VendorInvoicesRes', function($resource,$baseUrl){
  return $resource($baseUrl + '/api/v1/vendors/:id/invoices',
    {id: '@id'},
    {
...
.factory( 'EmailRes', function($resource,$baseUrl){
  return $resource($baseUrl + '/api/v1/emails/:id',
    {id: '@id'},
    {
      query: {method: 'GET', isArray: true},
      update: {method: 'PUT', params: {id: '@id'}, isArray:false}
...
.factory('NumberRes', function($resource,$baseUrl){
  return $resource($baseUrl + '/api/v1/numbers/:id',
    {id: '@id'},
    {
      query: {method: 'GET', isArray: true},
      update: {method: 'PUT', params: {id: '@id'}, isArray:false}
...
.factory('AddressRes', function($resource,$baseUrl){
  return $resource($baseUrl + '/api/v1/addresses/:id',
    {id: '@id'},
    {
      query: {method: 'GET', isArray: true},
      update: {method: 'PUT', params: {id: '@id'}, isArray:false}
