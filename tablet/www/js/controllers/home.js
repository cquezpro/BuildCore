...
.controller('HomeCtrl',  function ($scope, $ionicModal, $http, $ionicActionSheet,$ionicSideMenuDelegate, $baseUrl, $state, $ionicPopup, $ionicLoading, pdfDelegate, $ionicPopover, $window, $rootScope, $ionicScrollDelegate, $timeout) {
...
if (!window.requestAnimationFrame) {
  ...
  $scope.fetchMoreInvoices = function () {
    ...
    $ionicScrollDelegate.scrollBy(0, -700);
  ...
  $scope.showActions = function (invoice,$event) {
      ...
      var template = '<ion-modal-view id="actionPopup" style="z-index:9999; border-radius: 25px; border:2px solid #d3d3d3"><ion-content>',
        itemMenu;
      ...
      if ($scope.isPayableInvoice(invoice.category) && $scope.authorizeAction('pay-bill') && $scope.currentIndividual.user.verified) {
        //template =  template + '<div class="col col-50"><a class="item text-center" ng-click="clickMoreMenuItem(1)">Pay - due date</a></div>';
          ...
          itemMenu = '<div class="col col-33" ng-click="clickMoreMenuItem(1)">'+
          '<div class="row">'+
       ...
       if ($scope.isPayableInvoice(invoice.category) && $scope.authorizeAction('pay-bill') && $scope.currentIndividual.user.verified) {
        //template =  template + '<div class="col col-50"><a class="item text-center" ng-click="clickMoreMenuItem(1)">Pay - due date</a></div>';
          ...
          itemMenu = '<div class="col col-33" ng-click="clickMoreMenuItem(11)">'+
          '<div class="row">'+
          '  <div class="col text-center">'+
      ...
      if ($scope.isPayableInvoice(invoice.category) && $scope.authorizeAction('auto-pay-bill')) {
        //template =  template + '<div class="col col-50"><a class="item text-center" ng-click="clickMoreMenuItem(3)">Auto Pay</a></div>';
          ...
          itemMenu = '<div class="col col-33" ng-click="clickMoreMenuItem(3)">'+
          '<div class="row">'+
          '  <div class="col text-center">'+
      ...
      if ($scope.authorizeAction('mark-as-paid-bill') && $scope.currentIndividual.user.verified) {
        //template =  template + '<div class="col col-50"><a class="item text-center" ng-click="clickMoreMenuItem(2)">Mark paid</a></div>';
          ...
          itemMenu = '<div class="col col-33" ng-click="clickMoreMenuItem(2)">'+
          '<div class="row">'+
          '  <div class="col text-center">'+
      ...
      if ($scope.authorizeAction('approve-bill-as-accountant') && !invoice.accountant_approved) {
        //template =  template + '<div class="col col-50"><a class="item text-center" ng-click="clickMoreMenuItem(4)">Accountant Approved</a></div>';
          ...
          itemMenu = '<div class="col col-33" ng-click="clickMoreMenuItem(4)">'+
          '<div class="row">'+
          '  <div class="col text-center">'+
      ...
      if ($scope.authorizeAction('approve-bill') && !invoice.regular_approved) {
        //template =  template + '<div class="col col-50"><a class="item text-center" ng-click="clickMoreMenuItem(5)">Approved</a></div>';
          ...
          itemMenu = '<div class="col col-33" ng-click="clickMoreMenuItem(5)">'+
          '<div class="row">'+
          '  <div class="col text-center">'+
          '    <i class="icon ion-checkmark-round" style="font-size:35px;"></i>'+
          '  </div>'+
      ...
      if ($scope.authorizeAction('update-edit-bill')) {
        //template =  template + '<div class="col col-50"><a class="item text-center" ng-click="clickMoreMenuItem(6)">Edit</a></div>';
          ...
          itemMenu = '<div class="col col-33" ng-click="clickMoreMenuItem(6)">'+
          '<div class="row">'+
          '  <div class="col text-center">'+
      ...
      if ($scope.authorizeAction('delay-bill')) {
        //template =  template + '<div class="col col-50"><a class="item text-center" ng-click="clickMoreMenuItem(7)">Defer...</a></div>';
          ...
          itemMenu = '<div class="col col-33" ng-click="clickMoreMenuItem(7)">'+
          '<div class="row">'+
          '  <div class="col text-center">'+
      ...
      if ($scope.authorizeAction('delete-bill')) {
        //template =  template + '<div class="col col-50"><a class="item text-center">Delete</a></div>';
          ...
          itemMenu = '<div class="col col-33" ng-click="clickMoreMenuItem(9)">'+
          '<div class="row">'+
          '  <div class="col text-center">'+
      ...
      '<div class="row">'+
      '  <div class="col text-center">'+
      '    <i class="icon" style="font-size:15px;">x cancel</i>'+
      '  </div>'+
      '</div>';
      ...
      template = template + '</ion-content></ion-modal-view>';
  ...
  $scope.setCurrentInvoice = function (invoice) {
    ...
    if($scope.currentInvoice.total_alerts.length > 0 && $scope.currentInvoice.total_alerts !== null && $scope.currentInvoice.total_alerts !== undefined){
      ...
      for(var i=0;$scope.currentInvoice.total_alerts.length>i;i++){
        ...
        var category = $scope.currentInvoice.total_alerts[i].category;
        if((category == 'new_line_item' || category == 'line_item_quantity' || category == 'line_item_price_increase'))  {
          alertToShow = alertToShow + "<li>Line Item alert please see below.</li>";
        }
      }
