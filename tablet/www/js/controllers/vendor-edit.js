...
$scope.showActions = function (invoice,$event) {
      ...
      var template = '<ion-popover-view id="actionPopup" style="height:70%;border-radius: 25px;border:4px solid #d3d3d3; opacity: 1;"><ion-content>',
        itemMenu;
      ...
      '<div class="row">'+
      '  <div class="col text-center">'+
      '    <i class="icon ion-close" style="font-size:65px;"></i>'+
      '  </div>'+
      '</div>'+
      '<div class="row">'+
      '  <div class="col text-center" style="margin-left:-8px; font-size:30;" >'+
      '    Cancel'+
      '  </div>'+
      '</div>'+
      '</div>';
